"""
Prepare German P2G Training Data
...
Usage:
    python prepare_p2g_data_german.py --tsv_dir /path/to/phonemized --create_20h_subset
python3 prepare_p2g_data_german.py --tsv_dir /home/abhinav.pm/ABHI/SAL/v2/german_phoneme_smallset --create_20h_subset
"""
...
def analyze_tsv_with_duration(tsv_path, cache_path=None):
    ...
    Returns:
        tuple: (df, total_duration_hours, total_duration_minutes, duration_available)
    """
...
def main():
    parser = argparse.ArgumentParser(description="Analyze and prepare German P2G training data")
    parser.add_argument(
        "--tsv_dir",
        type=str,
        default="/home/abhinav.pm/ABHI/SAL/v2/german_phoneme_smallset",
        help="Directory containing phonemized TSV files"
    )
    parser.add_argument(
        "--cache_path",
        type=str,
        default="/scratch/ABHI/common_voice_de_190h",
    ...
    # File paths - UPDATE THESE TO MATCH YOUR GERMAN FILES
    train_tsv = os.path.join(args.tsv_dir, "common_voice_de_train_phoneme.tsv")
    valid_tsv = os.path.join(args.tsv_dir, "common_voice_de_validation_phoneme.tsv")
    test_tsv = os.path.join(args.tsv_dir, "common_voice_de_test_phoneme.tsv")
    ...
    print("="*70)
    print(" "*18 + "German P2G Data Analysis")
    print("="*70)
    ...
    if args.create_20h_subset:
        output_20h = os.path.join(args.tsv_dir, "common_voice_de_train_20h_phoneme.tsv")
        ...
        print(f"  train_tsv = os.path.join(TSV_DIR, 'common_voice_de_train_20h_phoneme.tsv')")
    ...
    print("\nTraining options:")
    print("  1. Full data (~41h):   python train_p2g_german.py")
    print("  2. 20h subset:         python train_p2g_german.py  # after updating train_tsv path")
    print("="*70)
